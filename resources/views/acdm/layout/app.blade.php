            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href=" {{ url('') }} ">
                        ...
                        <br>
                        <h4 class="brand-text">Airport Collaborative Decision Making System</h3>
                    </a>
                </li>
                ...
                @guest
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="{{ route('login') }}">
                    <span class="mr-1">{{ __('Login') }}
                    </span>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-puzzle-piece"></i><span class="menu-title" data-i18n="nav.starter_kit.main">Starter kit</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-1-column.html') }}"
                           data-i18n="nav.starter_kit.1_column">1 column</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-2-columns.html') }}"
                    ...
                    <li><a class="menu-item" href="#" data-i18n="nav.starter_kit.3_columns_detached.main">Content Det. Sidebar</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-left-sidebar.html') }}"
                                   data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_left_sidebar">Detached left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-left-sticky-sidebar.html') }}"
                                   data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_left_sidebar">Detached sticky left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-right-sidebar.html') }}"
                                   data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_right_sidebar">Detached right sidebar</a>
                            </li>
                            <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-content-detached-right-sticky-sidebar.html') }}"
                                   data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_right_sidebar">Detached sticky right sidebar</a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navbar.html') }}"
                           data-i18n="nav.starter_kit.fixed_navbar">Fixed navbar</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navigation.html') }}"
                           data-i18n="nav.starter_kit.fixed_navigation">Fixed navigation</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navbar-navigation.html') }}"
                           data-i18n="nav.starter_kit.fixed_navbar_navigation">Fixed navbar &amp; navigation</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-fixed-navbar-footer.html') }}"
                           data-i18n="nav.starter_kit.fixed_navbar_footer">Fixed navbar &amp; footer</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-fixed.html') }}"
                           data-i18n="nav.starter_kit.fixed_layout">Fixed layout</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-boxed.html') }}"
                           data-i18n="nav.starter_kit.boxed_layout">Boxed layout</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-static.html') }}"
                           data-i18n="nav.starter_kit.static_layout">Static layout</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-light.html') }}"
                           data-i18n="nav.starter_kit.light_layout">Light layout</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-dark.html') }}"
                           data-i18n="nav.starter_kit.dark_layout">Dark layout</a>
                    </li>
                    <li><a class="menu-item" href="{{ asset('starter-kit/ltr/vertical-overlay-menu-template/layout-semi-dark.html') }}"
